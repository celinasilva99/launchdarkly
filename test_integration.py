...
def flag_listener():
    ...
    current_flag_value = client.variation("feature_2.0", context, False)
    while True:
        time.sleep(2)  # Polling interval
        new_flag_value = client.variation("feature_2.0", context, False)
...
def handle_connect():
    ...
    context = Context.builder("context-key-123abc").name("Sandy").build()
    flag_value = client.variation("feature_2.0", context, False)
